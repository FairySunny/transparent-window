...
public class SplashOverlayMixin {
    ...
    private boolean wrapRenderFill(DrawContext instance, int x1, int y1, int x2, int y2, int color) {
    ...
    private boolean wrapRenderClearColor(CommandEncoder instance, GpuTexture gpuTexture, int i) {
        return MinecraftClient.getInstance().world != null;
    }
}
